...
let respondFrom = function (httpRes) {
  let contentType = get(httpRes, 'headers.content-type', 'application/json');
  let body =
  ...
  return new Promise((resolve, reject) => {
    ...
    let callback = function (err, response) {
      if (err) {
        ...
        let contentType = get(response, 'headers.content-type', 'application/json');
